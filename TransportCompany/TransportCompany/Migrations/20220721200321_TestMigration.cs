        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Authorization = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Managers_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Сategories_CategoryId",
            ...
            migrationBuilder.InsertData(
                table: "Logs",
                columns: new[] { "Id", "Authorization", "UserName" },
                values: new object[] { 1, new DateTime(2022, 7, 21, 23, 3, 21, 66, DateTimeKind.Local).AddTicks(9464), "ilyad" });
